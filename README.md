...
- `dump/`:
  ...
  - `admixture/`: the primary workspace for ADMIXTURE. Contains logs, fitted `Q` matrices, and benchmarking outputs.
  - `structure/`: the primary workspace for fastSTRUCTURE. Contains logs, `meanQ` matrices, and benchmarking outputs.
